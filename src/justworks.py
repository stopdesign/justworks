...
class API:
    ...
    def bypass_otp(self):
        ...
        tfa_info = self.parse_hydration_data(
            response.text, 'tfaInfo'
        )
    ...
    def update_csrf_token(self):
        ...
        csrf_token = self.parse_hydration_data(
            response.text, 'form_authenticity_token'
        )
    ...
    def get_constants(self):
        ...
        self.payment_dates = self.parse_hydration_data(response.text, 'upcomingPayDates')
        self.fringe_benefits_subtypes = self.parse_hydration_data(response.text, 'fringeBenefitsSubtypes')
