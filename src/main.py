...
@click.option('--password', prompt='Password (hidden)', help='Justworks account password.', hide_input=True)
@click.option('--dry', default=False, is_flag=True, help='Dry run. Do not change anything.')
